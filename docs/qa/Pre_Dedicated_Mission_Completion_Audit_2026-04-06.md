...
| Threat / IED / VBIED | runtime-only unverified | Threat/IED scope is locked in `/home/runner/work/COIN-Farabad-v0/COIN-Farabad-v0/docs/projectFiles/Farabad_THREAT_v0_IED_P1_Baseline_regen.md`; coupling audit in `/home/runner/work/COIN-Farabad-v0/COIN-Farabad-v0/docs/qa/IED_Threat_Economy_Coupling_Audit.md` has all five findings (F1-F5) **CLOSED**; driven VBIED + suicide bomber wired into exec tick; escalation-tier gates aligned between governor and execution layers | Needs fresh live proof for threat economy, spawn/disposal flow, and post-incident linkage | dedicated/JIP validation |
