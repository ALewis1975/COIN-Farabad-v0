...
{
    ["OPS", format ["ORDER: %1 attempted to issue %2 to %3, but an ISSUED order already exists.", _issuerStr, [_orderType] call ARC_fnc_intelOrderTypeLabel, _targetGroupId], [0,0,0],
        [
...
["OPS", format ["ORDER: %1 issued %2 (%3) to %4.", _issuerStr, _orderId, [_orderType] call ARC_fnc_intelOrderTypeLabel, _targetGroupId], [0,0,0],
    [
