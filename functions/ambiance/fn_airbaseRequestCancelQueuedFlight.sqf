...
if (!([_caller, "ARC_fnc_airbaseRequestCancelQueuedFlight", "Airbase cancel request rejected: sender verification failed.", "AIRBASE_CANCEL_SECURITY_DENIED", true, _reoOwner] call ARC_fnc_rpcValidateSender)) exitWith {false};
