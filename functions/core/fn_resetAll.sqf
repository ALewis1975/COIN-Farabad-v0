...
["supply_v1_seq", 0] call ARC_fnc_stateSet;
["supply_v1_stock", [["FUEL", _fuel], ["AMMO", _ammo], ["MED", _med], ["EQUIPMENT", 0.70]]] call ARC_fnc_stateSet;
["supply_v1_ledger", []] call ARC_fnc_stateSet;
...
["startdisp_v1_seq", 0] call ARC_fnc_stateSet;
["startdisp_v1_records", []] call ARC_fnc_stateSet;
["startdisp_v1_by_task", []] call ARC_fnc_stateSet;
["startdisp_v1_closed_index", []] call ARC_fnc_stateSet;
["activeIncidentStartdispId", ""] call ARC_fnc_stateSet;
["activeIncidentStartdispSummary", []] call ARC_fnc_stateSet;
["lastStartdispId", ""] call ARC_fnc_stateSet;
["lastStartdispAt", -1] call ARC_fnc_stateSet;
...
["lastSupplyAnnex", []] call ARC_fnc_stateSet;
["lastReadinessDelta", []] call ARC_fnc_stateSet;
