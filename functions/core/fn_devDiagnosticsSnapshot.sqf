...
{
    diag_log format ["[ARC][SEC] ARC_fnc_devDiagnosticsSnapshot: AUTHORIZATION_DENIED owner=%1 ts=%2", remoteExecutedOwner, serverTime];
    ["ARC_fnc_devDiagnosticsSnapshot", "AUTHORIZATION_DENIED", remoteExecutedOwner] call ARC_fnc_securityDenyRecord;
    false
};
