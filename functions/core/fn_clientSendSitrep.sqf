...
private _supplyPayload = _res param [10, []];
...
// Send to server / TOC
[player, _recU, _sum, _det, _pos, _updateOnly, _foReq, _foPurpose, _foRationale, _foConstraints, _foSupport, _foNotes, _foHoldIntent, _foHoldMinutes, _foProceedIntent, _supplyPayload] remoteExec ["ARC_fnc_tocReceiveSitrep", 2];
