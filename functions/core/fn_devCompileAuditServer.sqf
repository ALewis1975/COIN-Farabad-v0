...
{
    diag_log format ["[ARC][SEC] ARC_fnc_devCompileAuditServer: AUTHORIZATION_DENIED owner=%1 ts=%2", remoteExecutedOwner, serverTime];
    ["ARC_fnc_devCompileAuditServer", "AUTHORIZATION_DENIED", remoteExecutedOwner] call ARC_fnc_securityDenyRecord;
    false
};
