...
// -------------------------------------------------------------------------
// TOC-only tasking policy: do not issue RTB/HOLD/LEAD orders during closeout.
// Close the incident immediately, then publish a follow-on package to the TOC queue.
// -------------------------------------------------------------------------
