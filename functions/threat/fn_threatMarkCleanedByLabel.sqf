...
if ((_label select [0,7]) isNotEqualTo "THREAT:") exitWith {false};
...
if ((_parts # 0) isNotEqualTo "THREAT") exitWith {false};
...
if (_nid isNotEqualTo "") then { _note = format ["%1 nid=%2", _note, _nid]; };
