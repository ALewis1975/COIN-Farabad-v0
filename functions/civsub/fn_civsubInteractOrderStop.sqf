...
if (!([_actor, "ARC_fnc_civsubInteractOrderStop", "Request rejected: sender verification failed.", "CIVSUBINTERACTORDERSTOP_SECURITY_DENIED", false, _reoOwner] call ARC_fnc_rpcValidateSender)) exitWith {false};
