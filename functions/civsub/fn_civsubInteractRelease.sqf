...
if (!([_actor, "ARC_fnc_civsubInteractRelease", "Request rejected: sender verification failed.", "CIVSUBINTERACTRELEASE_SECURITY_DENIED", false, _reoOwner] call ARC_fnc_rpcValidateSender)) exitWith {false};
