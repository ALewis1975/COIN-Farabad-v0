...
if (!([_unit, "ARC_fnc_medicalCasevacRequest", "Request rejected: sender verification failed.", "MEDICALCASEVACREQUEST_SECURITY_DENIED", false, _reoOwner] call ARC_fnc_rpcValidateSender)) exitWith {""};
