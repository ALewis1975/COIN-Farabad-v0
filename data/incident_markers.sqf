...
[
    ...
    ["ARC_loc_OilProcessing", "Defend: Protect Oil Processing Site", "DEFEND"],
    ["ARC_loc_OilProcessing", "Patrol: Oil Processing Security", "PATROL"],
    ["ARC_loc_OilProcessing", "Logistics: Deliver Engineering Supplies", "LOGISTICS"],
    ["ARC_loc_OilProcessing", "Raid: Capture Oil Facility Saboteurs", "RAID"],
    ["ARC_loc_OilProcessing", "IED: Suspicious Vehicle Near Oil Processing", "IED"],
    ...
    ["ARC_loc_Mine16", "Recon: Mine Recon", "RECON"],
    ["ARC_loc_Mine16", "Patrol: Mine Security Patrol", "PATROL"],
    ["ARC_loc_Mine16", "Raid: Disrupt Mine Extortion Cell", "RAID"],
    ["ARC_loc_Mine16", "Logistics: Deliver Mine Supplies", "LOGISTICS"],
    ...
    ["ARC_loc_Mine18", "Recon: Mine Recon (East)", "RECON"],
    ["ARC_loc_Mine18", "Patrol: Mine Patrol (East)", "PATROL"],
    ["ARC_loc_Mine18", "Raid: Clear Mine Ambush Site", "RAID"],
    ["ARC_loc_Mine18", "IED: Suspected IED Near Mine Road", "IED"],

    ["ARC_loc_Mine19", "Recon: Mine Recon (South)", "RECON"],
    ["ARC_loc_Mine19", "Patrol: Mine Patrol (South)", "PATROL"],
    ["ARC_loc_Mine19", "Raid: Disrupt Illegal Mining Crew", "RAID"],
    ["ARC_loc_Mine19", "Logistics: Recover Equipment From Mine", "LOGISTICS"],

    ["ARC_loc_Mine20", "Recon: Mine Recon (West)", "RECON"],
    ["ARC_loc_Mine20", "Patrol: Mine Patrol (West)", "PATROL"],
    ["ARC_loc_Mine20", "Raid: Destroy Insurgent Cache at Mine", "RAID"],
    ["ARC_loc_Mine20", "IED: Mine Access Route IED", "IED"],

    ["ARC_loc_Mine21", "Recon: Mine Recon (North)", "RECON"],
    ["ARC_loc_Mine21", "Patrol: Mine Patrol (North)", "PATROL"],
    ["ARC_loc_Mine21", "Raid: Interdict Weapons Smuggling at Mine", "RAID"],
    ["ARC_loc_Mine21", "Logistics: Mine Security Contractor Escort", "ESCORT"],
