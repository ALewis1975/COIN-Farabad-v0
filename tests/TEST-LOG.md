...
|---|---|---|---|---|
| 1 | Pre-change target compat/lint | `python3 scripts/dev/sqflint_compat_scan.py --strict functions/core/fn_publicBroadcastState.sqf && sqflint -e w functions/core/fn_publicBroadcastState.sqf` | FAIL | Compat scan passed; `sqflint` was not installed in the sandbox before changes. |
