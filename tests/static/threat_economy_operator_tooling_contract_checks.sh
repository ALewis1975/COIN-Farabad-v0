...
check 'district_sec_level' "functions/threat/fn_threatSchedulerTick.sqf" "Scheduler ties threat profile to district posture"
check 'threat_subtype' "functions/threat/fn_threatSchedulerTick.sqf" "Scheduler records posture-selected threat subtype"
check 'intel_quality' "functions/threat/fn_threatScheduleEvent.sqf" "Scheduled ThreatRecords persist posture-derived intel quality"
check 'AMBUSH_NETWORK' "functions/threat/fn_threatScheduleEvent.sqf" "Non-IED ambush cues are emitted as network leads"
...
check 'posture_tier' "functions/threat/fn_threatEconomySnapshotBuild.sqf" "Economy snapshot exposes per-district posture tier"
check 'threat_costs' "functions/threat/fn_threatEconomySnapshotBuild.sqf" "Economy snapshot documents posture-driven threat costs"
